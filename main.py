...
<AudioTool>
    ...
    BoxLayout:
        ...
        TextInput:
            id: user_input
            text: '5'
            disabled: duration_switch.active == False # IF SWITCH IS OFF TEXTINPUT IS DISABLED 
...
class AudioTool(BoxLayout):
    ...
    def startRecording_clock(self):
        ...
        Clock.schedule_once(self.startRecording) #  start the recording 
    
    def startRecording(self, dt): # start the recorder
        self.r = MyRecorder()
    ...
    def stopRecording(self):
        ...
        Clock.unschedule(self.startRecording) # stop the recording of audio 
    ...
    def updateDisplay(self,dt):   
        if self.switch.active == False:
            ...
            if self.duration == 0: # 0
                ...
                self.stopRecording() #  THIS ONE LINE SHOULD TAKE CARE OF THE RECORDING NOT STOPPING. 
